...
const getAgents = async (req, res) => {
    try {
        // ⚡ Bolt: Added .lean() to bypass document hydration, returning plain JS objects instead.
        // This significantly reduces memory footprint and execution time for read-only endpoints.
