    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex items-center justify-between mb-6">
                ...
                <button aria-label="Close dialog" onClick={onClose} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 focus-visible:ring-2 focus-visible:outline-none rounded-full transition-colors">
                    <X size={20} />
                </button>
            </div>
