        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6 p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
            ...
            <div className="bg-gray-100 p-1 rounded-lg flex gap-1 border border-gray-200 w-full sm:w-auto justify-end sm:ml-auto">
                <button
                    ...
                    className={`p-2 rounded-md transition-all focus-visible:ring-2 focus-visible:outline-none ${viewMode === 'list' ? 'bg-white shadow text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
                    title="List View"
                >
                    <LayoutList size={18} />
                </button>
                <button
                    ...
                    className={`p-2 rounded-md transition-all focus-visible:ring-2 focus-visible:outline-none ${viewMode === 'grid' ? 'bg-white shadow text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
                    title="Grid View"
                >
                    <LayoutGrid size={18} />
                </button>
